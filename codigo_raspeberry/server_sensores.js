...
async function verificarAlertas(req) {
    ...
    if (req.body.nivel >= nivel_critico && req.body.nivel < vazio) {
        ...
        // Já foi enviado um alerta critico
        if (ultimo_alerta_Critico >= 0) {
            ...
            if (alerta_Critico[ultimo_alerta_Critico].nivel < req.body.nivel && variacao > 0.05) {
        ...
        // Lança um alerta (mas não foi enviado um alerta vazio)
        else {
        ...
        if (ultimo_alerta_Vazio >= 0) {
            ...
            // Se o valor tiver subido em relação ao ultimo valor lido remove-se esse elemento do array
            if (alerta_Vazio[ultimo_alerta_Vazio].nivel < req.body.nivel &&  variacao > 0.05) {
